...
function ChatModal({ onClose, t, lang, user }) {
  ...
  const send=async()=>{
    ...
    try{
      ...
      const res=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":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,"anthropic-version":"2023-06-01","anthropic-dangerous-direct-browser-access":"true"},body:JSON.stringify({model:"claude-3-5-haiku-20241022",max_tokens:1000,system:sys,messages:[...hist,{role:"user",content:txt}]})});
